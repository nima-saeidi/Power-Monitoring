...
from modules.audit_logs.models import AuditLog, CommandLog, DeviceTestLog
from core.logging import audit_logger


class AuditLogRepository:
    """Repository برای مدیریت لاگ‌های ممیزی"""
...
class CommandLogRepository:
    """Repository برای دستورات Modbus"""
